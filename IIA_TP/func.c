...
float eval_individual(int sol[], struct info d, int mat[][1], int *v)
{
	int     i;
...
// Parâmetros de entrada: solução (sol), capacidade da mochila (d), matriz com dados do problema (mat) e numero de objectos (v)
// Parâmetros de saída: qualidade da solução (se a capacidade for excedida devolve 0)
float eval_individual_penalizado(int sol[], struct info d, int mat[][1], int *v)
{
	int     i;
	float   sum_weight, sum_profit;
...
// Parâmetros de entrada: solução (sol), capacidade da mochila (d), matriz com dados do problema (mat) e numero de objectos (v)
// Parâmetros de saída: qualidade da solução (se a capacidade for excedida devolve 0)
float eval_individual_reparado1(int sol[], struct info d, int mat[][1], int *v)
{
	int     i;
	float   sum_weight, sum_profit;
...
// Parâmetros de entrada: solução (sol), capacidade da mochila (d), matriz com dados do problema (mat) e numero de objectos (v)
// Parâmetros de saída: qualidade da solução (se a capacidade for excedida devolve 0)
float eval_individual_reparado2(int sol[], struct info d, int mat[][1], int *v)
{
	int     i, mv, pos;
	float   sum_weight, sum_profit;
...
void evaluate(pchrom pop, struct info d, int mat[][1])
{
	int i;
